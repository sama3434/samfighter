...
export const MOVES = {
  punch: {
    ...
    dmg: DAMAGE.punch, reach: 132, top: -192, h: 52,
    kb: 7, kbY: 0, hitstun: 13, blockstun: 7, chip: CHIP_DAMAGE.punch, tone: 'punch',
    meterGain: 12.5,
  },
  kick: {
    key: 'kick', startup: 8, active: 6, recovery: 17,
    dmg: DAMAGE.kick, reach: 172, top: -144, h: 60,
    kb: 12, kbY: -7, hitstun: 20, blockstun: 12, chip: CHIP_DAMAGE.kick, tone: 'kick',
    meterGain: 25,
  },
  sweep: {
    key: 'sweep', startup: 7, active: 5, recovery: 21,
    dmg: DAMAGE.sweep, reach: 164, top: -60, h: 56,
    kb: 8, kbY: 0, hitstun: 24, blockstun: 12, chip: CHIP_DAMAGE.sweep, tone: 'kick',
    knockdown: true, low: true, meterGain: 25,
  },
  airPunch: {
    key: 'airPunch', startup: 3, active: 8, recovery: 6,
    dmg: DAMAGE.airPunch, reach: 124, top: -168, h: 68,
    kb: 6, kbY: 0, hitstun: 14, blockstun: 8, chip: CHIP_DAMAGE.airPunch, tone: 'punch', air: true,
    meterGain: 12.5,
  },
  airKick: {
    key: 'airKick', startup: 5, active: 10, recovery: 8,
    dmg: DAMAGE.airKick, reach: 160, top: -112, h: 80,
    kb: 10, kbY: 0, hitstun: 18, blockstun: 10, chip: CHIP_DAMAGE.airKick, tone: 'kick', air: true,
    meterGain: 25,
  },
  ...
  spin: {
    ...
    dmg: DAMAGE.spin, reach: 172, top: -132, h: 66,
    kb: 9, kbY: 0, hitstun: 20, blockstun: 14, chip: CHIP_DAMAGE.spin, tone: 'kick',
