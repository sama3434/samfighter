...
export const CHARACTERS = [
  ...
  },
  {
    ...
    /* The fire-hands trick: the *skin* and *glove* ramps are flame ramps, so
       ...
       through, and the hair ramp is a flame ramp too -- red roots, orange
       tips. His face stays human because his frames draw the head, neck,
